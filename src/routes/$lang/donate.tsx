  ...
  id: {
    ...
    howToDonate: {
      ...
      note: {
        ...
        afterEmail:
          'agar donasi Anda dapat kami catat dengan jelas. Jika Anda ingin donasi tersebut disalurkan ke proyek atau',
        initiativesLink: 'inisiatif tertentu yang didukung yayasan',
        afterInitiatives: ', silakan sebutkan dalam pesan surel Anda.',
      },
    },
    otherWays: {
    ...
    transparency: {
      ...
      description:
        'Kami berkomitmen untuk mengelola dana donasi dengan transparan dan bertanggung jawab. Kami menerbitkan buku kas publik untuk dana yang terkumpul dari donasi perorangan, yang dapat diakses oleh publik kapan saja. Keseluruhan keuangan Yayasan diringkas dan dilaporkan dalam laporan tahunan.',
  ...
  en: {
    ...
    howToDonate: {
      ...
      note: {
        ...
        email: 'humas@blankon.id',
        afterEmail:
          'so that we can record your donation clearly. If you would like your donation to go to a specific project or',
        initiativesLink: 'initiative supported by the foundation',
        afterInitiatives: ', please mention it in your message.',
      },
    },
    otherWays: {
    ...
    transparency: {
      ...
      description:
        'We are committed to managing donation funds transparently and responsibly. We publish a public cash book for funds gathered from individual donations, accessible to the public at any time. The Foundation’s full accounts are summarized and reported in our annual report.',
      cta: 'View the Public Cash Book',
    },
    contact: {
      title: 'Questions?',
      description:
        ...
        <section className="bg-slate-50 py-20 dark:bg-slate-900/50">
          <div className="container mx-auto max-w-5xl px-6">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-center text-sm text-fd-muted-foreground">
              ...
              <a
                href={`/${lang}/supported-initiatives`}
                className="font-medium text-blue-600 hover:underline dark:text-blue-400"
              >
                {content.howToDonate.note.initiativesLink}
              </a>
              {content.howToDonate.note.afterInitiatives}
            </p>
          </div>
        </section>
