    ...
    organization: {
      ...
      team: [
        ...
        },
        {
          ...
          position: 'Pengawas',
          bio: 'Kontributor BlankOn Linux sejak era 2000-an dengan keterlibatan mendalam di sisi teknis maupun strategis. Berpengalaman lebih dari satu dekade dalam pengelolaan organisasi nirlaba seperti Air Putih.',
          photo: '/images/akhmat-safrudin.png',
        },
        {
          name: 'Herpiko Dwi Aguno',
          position: 'Direktur',
          bio: 'Kontributor aktif BlankOn Linux sejak 2009 yang saat ini memimpin seluruh tim pengembangan distribusi Linux derivatif.',
    ...
    organization: {
      ...
      team: [
        ...
        },
        {
          name: 'Akhmat Safrudin',
          position: 'Supervisor',
          bio: 'A BlankOn Linux contributor since the 2000s, deeply involved in both technical development and strategic direction. Brings over a decade of experience in non-profit management through his work with Air Putih.',
          photo: '/images/akhmat-safrudin.png',
        },
        {
          name: 'Herpiko Dwi Aguno',
          position: 'Director',
          bio: 'An active BlankOn Linux contributor since 2009 who currently leads the entire derivative Linux distribution development team.',
          photo: '/images/herpiko.png',
        },
        {
          name: 'Slamet Santoso',
