    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: 'Laporan Keuangan', url: 'https://docs.google.com/spreadsheets/d/1C6bbNLCTwGavjFYyyTwES1z2NvqHgPEzySqe_Xw_m60/edit?usp=sharing' },
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: 'Financial Report', url: 'https://docs.google.com/spreadsheets/d/1C6bbNLCTwGavjFYyyTwES1z2NvqHgPEzySqe_Xw_m60/edit?usp=sharing' },
